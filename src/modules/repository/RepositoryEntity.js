class RepositoryEntity {
      constructor(id, assignable_users, code_of_conduct, created_at, database_id, 
        default_branch, delete_branch_on_merge, description, disk_usage, forks,
        has_issues_enabled, has_projects_enabled, has_wiki_enabled, homepage_url,
        is_archived, is_blank_issues_enabled, is_disabled, is_empty, is_fork, 
        is_in_organization, is_locked, is_mirror, is_private, is_security_policy_enabled,
        is_template, is_user_configuration_repository, issues, labels,
        languages, license_info, mentionable_users, merge_commit_allowed, milestones,
        name, name_with_owner, open_graph_image_url, owners, primary_language, pushed_at, pull_requests, 
        rebase_merge_allowed, releases, repository_topics, squash_merge_allowed, stargazers,
        tags, updated_at, url, uses_custom_open_graph_image, vulnerability_alerts, watchers) {
            this.id = id;
